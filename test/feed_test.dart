...
main() {
  ...
  group('fetchFeed', () {
    ...
    test('returns a feed if http call completes successfully', () async {
      ...
      when(client.get('https://rss.itunes.apple.com/api/v1/gb/podcasts/top-podcasts/all/10/explicit.json'))
        .thenAnswer((_) async => http.Response(await file.readAsString(), 200));
